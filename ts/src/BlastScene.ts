...
import { XY } from "./gametype";
import { GameData, GameOption } from "./main";
import { ResInfo } from "./res";
...
export class BlastScene extends Phaser.Scene
{
    ...
    protected loading_pv = 0; // 로딩 시간을 저장하는 임시 변수. 이전 항목의 로딩 시간 저장용.
    protected img_bg = null;
    /** 테스트용 볼 이미지 */
    protected img_ball = null;
    protected img_tilebg = null;

    protected stageView:StageView = null;
...
class StageView
{
    protected stageLogic = null;
    protected boardPixelSize = null;
    protected boardXYLen = null;
    protected pivotPos = null;
    protected tilePixelSize = null;
    protected boardLeftTopWPos = null;

    protected tileImgArr = null;
    protected tileImgGroup = null;
